...
Animation::Animation()
	: currentClip(-1), position(0,0),rotation(0,0,0)
{
...
bool Animation::AABB(D3DXVECTOR2 & position)
{
	return Sprite::AABB(GetSprite(), position);
}

bool Animation::AABB(Sprite * b)
{
	return Sprite::AABB(GetSprite(), b);
}
